...
" ======
if s:vim9script
  syn keyword	vim9Export	export	skipwhite nextgroup=vim9Abstract,vim9ClassBody,vim9Const,vim9Def,vim9EnumBody,vim9Final,vim9InterfaceBody,vim9Var
endif
...
if exists("g:vimsyn_folding") && g:vimsyn_folding =~# 'f'
 ...
 syn region	vimDefFold	start="\%(^\s*\%(static\s\+\)\=\)\@32<=:\=\s*def\>!\=\s*\%(<[sS][iI][dD]>\|[sg]:\)\=\%(\i\|[#.]\)\+(" end="^\s*:\=\s*enddef\>"          contains=vimDef      fold keepend extend transparent
 syn region	vimDefFold	start="^\s*:\=\s*def\s\+new\i\+("				            end="^\s*:\=\s*enddef\>"          contains=vimDef      fold keepend extend transparent
endif
...
if s:vim9script
  " Classes {{{3
  syn cluster	vim9ClassBodyList		contains=vim9Comment,@vim9Continue,vim9Abstract,vim9Class,vimDef,@vimExprList,vimLetHereDoc,vim9Extends,vim9ClassIdentifier,vim9Implements,vim9Public,vim9Static,vim9Const,vim9Final,vim9Var,vimDefFold
  ...
  syn keyword	vim9ClassIdentifier	contained	this super

  VimFoldc syn region	vim9ClassBody	start="\<class\>" matchgroup=vimCommand end="\<endclass\>" contains=@vim9ClassBodyList transparent

  " Enums {{{3
  syn cluster	vim9EnumBodyList		contains=vim9Comment,@vim9Continue,vim9Implements,vimDef,vim9Var,vimDefFold,vim9Enum
  ...
  syn cluster	vim9InterfaceBodyList	contains=vim9Comment,@vim9Continue,vim9Extends,vim9Interface,vim9AbstractDef,vim9Var
  ...
  syn match	vim9AbstractDefName	contained	"\<\h\w*\>"	skipwhite nextgroup=vim9AbstractDefParams contains=vimMethodName
...
if !exists("skip_vim_syntax_inits")
 ...
 hi def link vim9ClassIdentifier	Identifier
